...
- **User input tips, selection, and status indicators:** Use `HIGHLIGHT` from `crate::style` (a soft green: `rgb(213, 240, 216)`).
...
- Avoid ANSI `blue`, `yellow`, and `cyan` because the style guide doesn't use them. Prefer a foreground color mentioned above.
